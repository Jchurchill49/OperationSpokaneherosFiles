...
<body>
     ...
     <ul class="ui-tabs-nav">  
        ...
        <li class="ui-tabs-nav-item" id="nav-fragment-3"><a href="#fragment-3"><img src="featured-content-slider/featured-content-slider/images/image3-small.png" alt="" /><span>Contact Us To Help </span></a>
       </li>  
     </ul>  
     <!-- First Content -->  
     <div id="fragment-1" class="ui-tabs-panel" style="">  
         <img src="featured-content-slider/featured-content-slider/images/image1.jpg" alt="" />  
       <div class="info" >  
         <h2><a href="#" >Holiday Care Package</a></h2>  
         <p>Operation Spokane Heroes is collecting items for Holiday Care Packages to be 
	sent to deployed Navy troops from our local Naval Reserve Center.....<a href="pdf/Holiday Navy Care Packages Media Advisory.pdf" >More Information</a></p>  
       </div>  
     </div>  
     <!-- Second Content -->  
     <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide" style="">  
         <img src="featured-content-slider/featured-content-slider/images/image2.jpg" alt="" />  
         <div class="info" >  
     ...
     <div id="fragment-3" class="ui-tabs-panel ui-tabs-hide" style="">  
         <img src="featured-content-slider/featured-content-slider/images/image3.jpg" alt="" />  
    <!--     <div class="info" >  
